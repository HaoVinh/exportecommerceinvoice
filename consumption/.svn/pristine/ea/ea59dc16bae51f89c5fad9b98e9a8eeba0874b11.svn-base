...
import trong.lixco.com.api.DateJsonDeserializer;
import trong.lixco.com.api.DateJsonSerializer;
...
public class JsonParserUtil {
    ...
    static {
        ...
        gsonBuilder.registerTypeAdapter(java.sql.Date.class,new DateSerializerSQL())
		.registerTypeAdapter(java.sql.Date.class,new DateDeserializerSQL());
        gsonnew = gsonBuilder.create();
    }

	public JsonParserUtil() {
	}
	public static Gson getGson(Type type,StringBuilder messages){
		Gson gson = new GsonBuilder().registerTypeAdapter(Date.class, new DateDeserializer())
				.registerTypeAdapter(Date.class, new DateSerializer())
				.registerTypeAdapter(java.sql.Date.class,new DateSerializerSQL())
				.registerTypeAdapter(java.sql.Date.class,new DateDeserializerSQL())
				.registerTypeAdapter(type, new AnnotatedDeserializer<>(messages)).registerTypeAdapterFactory(HibernateProxyTypeAdapter.FACTORY).
	...
	private static final Gson gson = new GsonBuilder().registerTypeAdapter(Date.class, new DateDeserializer())
			.registerTypeAdapter(Date.class, new DateSerializer())
			.registerTypeAdapter(java.sql.Date.class,new DateSerializerSQL())
			.registerTypeAdapter(java.sql.Date.class,new DateDeserializerSQL()).registerTypeAdapterFactory(HibernateProxyTypeAdapter.FACTORY).create();
