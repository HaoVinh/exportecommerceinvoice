...
//  private static final Gson _gson = new Gson();
  ...
  public static String FormatResponse2(int error, String msg,String objName, JsonElement jsonEle) {
	  if ((error == 0) && (msg.equals(""))) {
		  msg = "No error";
	  }
	  JsonObject json = new JsonObject();
	  ...
	  json.addProperty("msg", msg);
	  json.add("dt", jsonEle);
	  return  new GsonBuilder().serializeNulls().registerTypeAdapter(Date.class, new DateDeserializer()).registerTypeAdapter(Date.class, new DateSerializer()).create().toJson(json);
  }
