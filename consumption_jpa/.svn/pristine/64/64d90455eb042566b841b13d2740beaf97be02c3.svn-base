...
@Entity
@Table(name="exportbatchod")
public class ExportBatchOD implements Serializable,Cloneable{
	...
	private double box_quantity;//so luong xuat (thùng).
	@Transient
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ExportBatchOD other = (ExportBatchOD) obj;
		if (id != other.id)
			return false;
		return true;
	}
	@Override
	public ExportBatchOD clone() throws CloneNotSupportedException {
		return (ExportBatchOD) super.clone();
	}
}
