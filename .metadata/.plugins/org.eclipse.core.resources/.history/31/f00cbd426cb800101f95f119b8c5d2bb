...
public class ShopeeTokenManagerV2 {
	...
	private static final long PARTNER_ID = 2013449L;
	private static final String PARTNER_KEY = "shpk4645677075614d506d4e557472517855526a77426f53686a746a7a42787a";
...
//
	public static void main(String[] args) {
		...
		String authCode = "43506b54697a4b69664e717247445163";
