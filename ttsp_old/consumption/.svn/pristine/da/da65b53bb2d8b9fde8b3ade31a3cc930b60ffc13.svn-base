...
public interface IInvoiceService {
	...
	public int search(String json, List<InvoiceDTO3> list,List<CustomerChannel> customerChannels, List<CustomerTypes> customerTypes,boolean chuachuyenmisa,int giohanHDtruyvan,List<IECategories> ieCategoriesSearchs, List<Customer> customerSearchs);
