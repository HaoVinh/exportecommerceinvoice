...
public class ReportInSanPhamBean extends AbstractBean {
	...
	public void initListLoaiBaoCaoInSanPham(){
		try{
			...
			listLoaiBaoCaoInSanPham.add(new LoaiBaoCaoInSanPham(11, "11.Thẻ kho sản phẩm(Kg)"));
			listLoaiBaoCaoInSanPham.add(new LoaiBaoCaoInSanPham(31, "11_.Thẻ kho sản phẩm(ĐVT)"));
			...
			listLoaiBaoCaoInSanPham.add(new LoaiBaoCaoInSanPham(30, "30.Hàng chậm luân chuyển(BN)"));
			//Đã tới số 31
			//listLoaiBaoCaoInSanPham.add(new LoaiBaoCaoInSanPham(31, "11.Thẻ kho sản phẩm(Kg)"));
		}catch (Exception e) {
		}
	}
	public String includeViewPage(){
		...
		try{
			if(loaiBaoCaoInSanPhamSelect!=null){
				...
				case 30:
					return "/pages/baocao/hang_cham_luan_chuyen_bn.xhtml";
				case 31:
					return "/pages/baocao/the_kho_san_pham_dvt.xhtml";
				default:
