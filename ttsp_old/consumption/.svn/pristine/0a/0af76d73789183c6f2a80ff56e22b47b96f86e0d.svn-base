...
public class UserRightDataService {
	public static final String NAME = "userright";
	static Gson gson;
	static {
	 ...
	 * @return Chuong trinh
	 */
	public static UserRightData[] dsform(long idaccount,long idprogram) {
		try {
			...
			UserRightData[] userRightDatas = gson.fromJson(ketqua.getDt(), UserRightData[].class);
