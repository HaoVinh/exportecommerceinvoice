...
public class TongKetXuatTheoSanPhamTongKetTieuThuLoai1 {
	...
	public TongKetXuatTheoSanPhamTongKetTieuThuLoai1() {
	}
	
	public TongKetXuatTheoSanPhamTongKetTieuThuLoai1(long product_type_id, String product_type_name, long product_id,
			String product_name, Double quantity, Double total_amount, Double total_tax_amount,
			Double total_amount_with_vat) {
