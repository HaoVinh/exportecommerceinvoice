...
public class PromotionProgramDetail implements Serializable,Cloneable{
	...
	private double specification;//số sản phẩm khuyến mãi
	private double promotion_quantity;//số sản phẩm khuyến mãi (bỏ không còn sử dụng)
	private int promotion_form;//hinhthuckhuyenmai
	public PromotionProgramDetail(PromotionProgramDetailDTO ppd) {
	...
	public PromotionProgramDetail(long id) {
	}
	public long getId() {
		return id;
	}
