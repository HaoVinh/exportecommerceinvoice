...
//						dagiaohang, shippedper, term_deliv, load_date, portoftran, freight, ref_no, taixe, ghichu, shipmark
						...
						item.addProperty("ngay",ToolTimeCustomer.convertDateToString((Date)p[4],"yyyy-MM-dd HH:mm:ss"));
						...
						item.addProperty("etd",ToolTimeCustomer.convertDateToString((Date)p[15],"yyyy-MM-dd HH:mm:ss"));
						...
						item.addProperty("load_date",ToolTimeCustomer.convertDateToString((Date)p[25],"yyyy-MM-dd HH:mm:ss"));
