...
public interface IProcessLogicGoodsReceiptNoteService {
	...
	public int insertGoodsReceiptNoteDetailFromDelivery(GoodsReceiptNoteDetailReqInfo t, Message message) throws IllegalStateException, SystemException, SQLException;
	public int synthesizeDataFromDelivery(WrapListGoodsReceiptNoteDetailReqInfo t, Message message) throws IllegalStateException, SystemException, SQLException;
}
