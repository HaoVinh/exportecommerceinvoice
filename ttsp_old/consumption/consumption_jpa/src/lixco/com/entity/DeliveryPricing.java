...
public class DeliveryPricing implements Serializable,Cloneable{
	...
	public DeliveryPricing(DeliveryPricingDTO dto) {
		this.place_code = dto.getPlace_code();
		this.address = dto.getAddress();
		this.km = dto.getKm();
		this.unit_price = dto.getUnit_price();
		this.unit_priceun = dto.getUnit_priceun();
		this.place_arrived = dto.getPlace_arrived();
		this.disable = dto.isDisable();
	}
