...
public class CustomerPromotionProgram implements Serializable,Cloneable{// chương trình khách hàng km
	...
	public CustomerPromotionProgram(CustomerPromotionProgramDTO cpp) {
	...
	public CustomerPromotionProgram(long id) {
		this.id = id;
	}
	public CustomerPromotionProgram(long id, long customerId, long promotionProgramId, Date effective_date,
			Date expiry_date) {
		this.id = id;
		this.customer = new Customer(customerId);
		this.promotion_program = new PromotionProgram(promotionProgramId);
		this.effective_date = effective_date;
		this.expiry_date = expiry_date;
	}
	public CustomerPromotionProgram(long id, long customerId, long promotionProgramId,String promotionProgramCode,
			Date promotionProgramEffectiveDate,Date promotionProgramExpiryDate, Date effective_date,
			Date expiry_date) {
		this.id = id;
		this.customer = new Customer(customerId);
		this.promotion_program = new PromotionProgram(promotionProgramId, promotionProgramCode, promotionProgramEffectiveDate, promotionProgramExpiryDate);
		this.effective_date = effective_date;
		this.expiry_date = expiry_date;
	}
