...
public class IEInvoiceDetail implements Serializable,Cloneable{
	...
	private String seal_number;//số seal
	...
	@Transient
	private boolean capnhatdsphieu;
	public long getId() {
		return id;
	}
	...
	public boolean isCapnhatdsphieu() {
		return capnhatdsphieu;
	}
	public void setCapnhatdsphieu(boolean capnhatdsphieu) {
		this.capnhatdsphieu = capnhatdsphieu;
	}
	@Override
