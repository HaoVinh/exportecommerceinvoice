...
private Date giahanluukho;
	...
	public YeuCauKiemTraHangDetailDTO(long id, String masp, String tensp, String dvt, String dvt_baobi,
			double hsquidoithung, double quantity, String lohang, int nguongoc, String tinhtrang,
			boolean kiemtradat, String tieuchuan, String nguyennhan, String huonggiaiquyet,Date giahanluukho) {
		super();
		this.id = id;
		this.masp = masp;
		this.tensp = tensp;
