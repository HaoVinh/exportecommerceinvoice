...
public class FreightContractDetail implements Serializable,Cloneable{// chi tiết hợp đồng vận chuyển
	...
	public FreightContractDetail() {
	}
	
	public FreightContractDetail(long productTypeId,String productTypeCode,String productTypeName, double quantity) {
		this.product_type = new ProductType(productTypeId, productTypeCode, productTypeName);
	...
	public boolean equals(Object obj) {
		...
		if (id != other.id){
			...
			if(product_type!=null && other.product_type !=null &&product_type.equals(other.product_type)){
				return true;
			}
		}
		return true;
