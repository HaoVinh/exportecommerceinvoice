...
public class IECommercialInvoiceReportInfo {
	...
	public IECommercialInvoiceReportInfo(long product_id, String product_code, String product_en_name, double specification, String unit,
			long product_type_id, String product_type_en_name, double quantity_export,
			double foreign_unit_price, double total_export_foreign_amount,String orderno) {
