...
@ApplicationScoped
public class ShopeeTokenManagerV2 {
	private static final Logger LOGGER = Logger.getLogger(ShopeeTokenManagerV2.class.getName());
	private static final long PARTNER_ID = 2012115L;
	private static final String PARTNER_KEY = "shpk49527570565651714d5073594d55555345446f6252716c494663516a6976";
	...
	public synchronized String getAccessToken() {
		try {
			...
			currentToken = shopeeTokenService.findById(2);
	...
	private void refreshToken() {
		try {
			...
			ShopeeToken existingToken = shopeeTokenService.findById(2);
...
//
	public static void main(String[] args) {
		ShopeeTokenManagerV2 tokenManager = new ShopeeTokenManagerV2();
		String authCode = "4248566c4c4341655a64657758474d53";
