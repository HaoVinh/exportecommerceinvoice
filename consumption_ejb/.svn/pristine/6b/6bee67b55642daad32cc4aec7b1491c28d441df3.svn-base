...
public interface IProcessLogicInvoiceService {
	...
	public int createInvoiceByExtensionOrder(WrapExtensionOrderReqInfo t,List<Long> listIdResult,StringBuilder messages,String soxe, boolean kiemton,String thukho) throws IllegalStateException, SystemException, SQLException;
	...
	int deleteInvoiceDetailTempMaster(WrapDelInvoiceDetailReqInfo ta, Message message, String userAction)
			throws IllegalStateException, SystemException, SQLException;
	int createInvoiceByOrderEcom(EcomOrder t, StringBuilder messages, boolean kiemton)
			throws IllegalStateException, SystemException, SQLException;
